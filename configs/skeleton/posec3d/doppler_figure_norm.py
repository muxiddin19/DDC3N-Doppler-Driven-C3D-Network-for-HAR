...
ann_file_train = 'data/doppler/doppler_train_norm.pkl' #Figure norm
ann_file_test = 'data/doppler/doppler_test_norm.pkl' #Figure norm
ann_file_val = 'data/doppler/doppler_val_norm.pkl' #Figure norm
