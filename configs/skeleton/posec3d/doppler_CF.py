...
ann_file_train = './data/doppler/dop_train.pkl'   #CrossFit
ann_file_val = './data/doppler/dop_val.pkl'       #CrossFit
ann_file_test = './data/doppler/dop_test.pkl'     #CrossFit
...
log_level = 'INFO'
work_dir = './work_dirs/dopp_CF_full'
load_from = None
resume_from = None
