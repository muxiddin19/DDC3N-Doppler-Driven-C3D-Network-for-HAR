...
ann_file_train = './data/doppler/dop_train__full.pkl'   #CrossFit
ann_file_val = './data/doppler/dop_val__full.pkl'       #CrossFit
ann_file_test = './data/doppler/dop_test__full.pkl'     #CrossFit
...
log_level = 'INFO'
work_dir = './work_dirs/dopp_CF_full1'
load_from = None
resume_from = None
